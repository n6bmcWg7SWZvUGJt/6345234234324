const taskTemplate = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="content">
<div class="tabBody">
<input type="checkbox" id="Как создать шаблон484" class="hide"/>
<label class="detail-title" for="Как создать шаблон484">Как создать шаблон</label>
...
<div class="content">
<div class="tabBody">
<input type="checkbox" id="Как открыть доступ к шаблону другим пользователям233" class="hide"/>
<label class="detail-title" for="Как открыть доступ к шаблону другим пользователям233">Как открыть доступ к шаблону другим пользователям</label>
<div class="detail-content">
<div class="dc">
...
<div class="content">
<div class="tabBody">
<input type="checkbox" id="Как создать карточку из шаблона716" class="hide"/>
<label class="detail-title" for="Как создать карточку из шаблона716">Как создать карточку из шаблона</label>
<div class="detail-content">
<div class="dc">
</p>
</div>
