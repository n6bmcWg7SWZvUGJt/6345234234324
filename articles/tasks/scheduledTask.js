...
<div class="paragraph">
<p><span class="image"><img src="media/image1.png" alt="image" width="450" height="170"></span></p>
</div>
<div class="paragraph">
...
<div class="tabs" id="Scheduled TaskTabs"><button class="tablinkScheduled Task" onclick="openPage('Scheduled Tasktab1', this)" id="defaultOpenScheduled Task">
Copy</button><button class="tablinkScheduled Task" onclick="openPage('Scheduled Tasktab2', this)" >
New</button><button class="tablinkScheduled Task" onclick="openPage('Scheduled Tasktab3', this)" >
</button></div>
      <div class="tabsPages" id="Scheduled TaskPages">   <div id="Scheduled Tasktab1" class="tabcontentScheduled Task" style="display: none;">
                    <div class="paragraph">
...
<span class="image"><img src="media/image2.png" alt="image" width="108" height="31"></span> – «Копировать».</p>
</div>
<div class="paragraph">
<p><span class="image"><img src="media/image3.png" alt="image" width="359" height="187"></span></p>
</div>
<div class="paragraph">
<p>Копирование периодической задачи</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p><span class="image"><img src="media/image4.png" alt="image" width="464" height="301"></span>
Вкладка «Созданные задачи» периодической задачи</p>
</div>
                     </div>   <div id="Scheduled Tasktab2" class="tabcontentScheduled Task" style="display: none;">
                    <div class="paragraph">
...
<ol class="arabic">
<li>
<p>Нажмите на кнопку <span class="image"><img src="media/image2.png" alt="image" width="108" height="31"></span> –
«Новую».</p>
</li>
<li>
<p>В открывшемся окне на вкладке «Главная» укажите название задачи и
краткое описание.
<span class="image"><img src="media/image3.png" alt="image" width="457" height="188"></span>
Редактирование периодической задачи
Нажатие на кнопку <span class="image"><img src="media/image4.png" alt="image" width="50" height="25"></span>
открыает выбранное действие для редактирования.
...
<span class="image"><img src="media/image5.png" alt="image" width="74" height="25"></span> .</p>
</li>
<li>
...
<li>
<p>Нажмите на кнопку <span class="image"><img src="media/image6.png" alt="image" width="83" height="33"></span> и
...
<div class="paragraph">
<p><span class="image"><img src="media/image7.png" alt="image" width="432" height="155"></span></p>
</div>
<div class="paragraph">
<p>Список периодических задач</p>
</div>
                     </div>   <div id="Scheduled Tasktab3" class="tabcontentScheduled Task" style="display: none;">
                    
                     </div></div>

<script>
function openPageScheduled Task(pageName,elmnt) {
  var i, tabcontentScheduled Task, tablinks;
  tabcontentScheduled Task = document.getElementsByClassName("tabcontentScheduled Task");
  for (i = 0; i < tabcontentScheduled Task.length; i++) {
    tabcontentScheduled Task[i].style.display = "none";
  }
  tablinks = document.getElementsByClassName("tablinkScheduled Task");
...
document.getElementById("defaultOpenScheduled Task").click();
</script>
`;