...
articles.set('банкиивалюты', банкиивалюты);
articles.set('вариантыуведомлений', вариантыуведомлений);
articles.set('контрагенты', контрагенты);
articles.set('нашаорганизация', нашаорганизация);
articles.set('общиесправочники', общиесправочники);
articles.set('работасосписком', работасосписком);
articles.set('синхронизация', синхронизация);
articles.set('фильтрация', фильтрация);
...
articles.set('taskсard', taskСard);
